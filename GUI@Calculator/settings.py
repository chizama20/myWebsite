...
MATH_POSITIONS = {
    '/': {'col': 3, 'row': 2, 'character': '', 'operator': '/', 'image_path': {'light': 'GUI@Calculator/images/divisionLight.png', 'dark': 'GUI@Calculator/images/divisionDark.png'}},
...
OPERATORS = {
    ...
    'invert': {'col': 1, 'row': 2, 'text': '', 'image_path': {'light': 'GUI@Calculator/images/plusminusLight.png', 'dark': 'GUI@Calculator/images/plusminusDark.png'}},
